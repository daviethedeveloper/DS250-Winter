...
In my classification model, the features I excluded were the yearbuilt, parcel and before1980. This decision is based off the results that can increase my model to predict 100%. So, to preven my model reaching 100% accuracy, I excluded these features. As seen in my printed features with their importance weight, the highest is live area with 0.07. From this result, I can conclude living area will be helpful feature to know if homes were built before 1980.
